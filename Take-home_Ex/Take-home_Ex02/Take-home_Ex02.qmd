...
Throughout, a consistent colour language is used: amber for the two agents at the
centre of the breach (Legal and Social-Media), cyan for the compliant agents and
the overseer, grey for the background agents, and red reserved for the breach
itself.
...
For most of the two weeks the team keeps a calm rhythm. Platform-Trust does the
heavy lifting day to day and posts the most in the quiet period, while the two
interns only appear from 24 May, which fits their "first week" messages.
...
The more revealing pattern is who falls silent. Platform-Trust sends one last
burst at noon, then drops off for the rest of the day. The Judge, the agent meant
to keep everyone in line, barely registers at all on 5 June. So at the moment the
crisis peaks, two agents are doing nearly all the talking and the agents
responsible for oversight have gone quiet. Whether that silence was a cause or a
symptom is a question the next figures take up.
